...
By default this module will send "index" files in response to a request
...
var serve = serveStatic('public/ftp', { 'index': ['index', 'index.htm'] })
...
app.use(serveStatic('public/ftp', { 'index': ['default', 'default.htm'] }))
app.listen(3000)
```
